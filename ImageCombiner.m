...
if strncmp(response,'m',1)
    ...
    directory = input('Please enter the name of the directory:','s');
    ...
    [imageNames] = GenerateImageList(directory,fileType);
    
    % Read in the list of specified images
    % You will need to implement ReadImages
    images = ReadImages(directory,imageNames);
...
% Remove unwanted data from thei sequence of images
